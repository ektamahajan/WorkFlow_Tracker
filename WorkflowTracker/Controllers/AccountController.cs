...
namespace WorkflowTracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        emahajanDataBaseEntities5 db = new emahajanDataBaseEntities5();
            ...
            // To enable password failures to trigger account lockout, change to shouldLockout: true
                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        ...
                        emahajanDataBaseEntities5 db = new emahajanDataBaseEntities5();
                    // To get the last login of the user
                        AspNetUser logged = db.AspNetUsers.SingleOrDefault(u => u.UserName == model.Email);
                        Session["lastLoggedTime"] = logged.LastLoginDate;
                        logged.LastLoginDate = DateTime.Now;
